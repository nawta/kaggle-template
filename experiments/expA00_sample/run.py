"""
expA00_sample: Claude用サンプル実験

設計ドキュメント: docs/experiments.md
関連クラス: utils.env.EnvConfig, utils.logger, utils.timing
命名規則: exp{A-Z}{NN}_ はClaude実行の実験を示す（KAGGLE_DIRECTION.md参照）
"""
...
def main(
    ...
    exp_name = f"{Path(sys.argv[0]).parent.name}/{HydraConfig.get().runtime.choices.exp}"  # e.g. expA00_sample/default
